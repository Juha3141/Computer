...
class InstructionController {
    public:
        InstructionController(std::vector<std::pair<AssemblyInstruction,int>>*full_contents) : asm_source(full_contents) {
            ...
            AssemblyCode codes[] = {
                {"nop"     , 0 , {0x00 , 0xFF , 0xFF , 0xFF , 0xFF , 0xFF , 0xFF , 0xFF , 0xFF , 0xFF , 0xFF , 0xFF}} , 
                ...
                {"out"     , 1 , {0xFF , 0x13 , 0x15 , 0x12 , 0xFF , 0xFF , 0x14 , 0xFF , 0xFF , 0xFF , 0xFF , 0xFF}} , 
        ...
        int convert_instruction(AssemblyInstruction instruction);
